...
class Font:
    Default = pygame.font.SysFont("Ubuntu Light", 20)
    Small = pygame.font.SysFont("Ubuntu Light", 15)
    Medium = pygame.font.SysFont("Ubuntu Light", 40)
    Large = pygame.font.SysFont("Ubuntu Light", 60)
    Scanner = pygame.font.SysFont("Ubuntu Light", 30)
